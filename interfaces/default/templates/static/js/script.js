...
(function () {
    ...
    var contentLayouts = {},
        ...
        playSong = function (songIndex) {
            ...
            showInfo(song);
            songUrl = 'get_song?format=' + formats[activeSolution].join(',') + '&songid=' + song + '&bitrate=' + parseInt(bitrate, 10);
            ...
            buttons: {
                ...
                "Add User": function() {
                    ...
                    var userInfo = {
                        ...
                        real_name: $("#new-user-full-name").val(),
                        password: $("#new-user-password").val(),
                        admin: $("#new-user-admin").is(":checked")
                    };
                    $.ajax({
                        url: 'add_user',
                        data: userInfo,
